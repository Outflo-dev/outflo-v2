/* ==========================================================
   ...
   File: src/components/system/primitives/onboarding/page/internal/alternate/OnboardingPageAlternate.tsx
   Scope: Render the canonical alternate route within an onboarding page
   Last Updated:
   - date: 2026-07-29
   - note: consume the shared alternate-route configuration contract
   ========================================================== */
